...
import 'package:task_manager/features/duetodaytasks/bloc/due_today_bloc.dart';
...
class DueTodayTaskScreen extends StatefulWidget {
  final QuickActionModel action;
  const DueTodayTaskScreen({super.key, required this.action});
...
class _DueTodayTaskScreenState extends State<DueTodayTaskScreen>
  ...
  void didChangeDependencies() {
    ...
    _bloc = context.read<DueTodayBloc>();
  }
  ...
  void _onTabChanged(int index) {
    final bloc = context.read<DueTodayBloc>();
  ...
  void _onScroll(String tabId) {
    ...
    if (controller.position.pixels >=
      ...
      final state = context.read<DueTodayBloc>().state;
